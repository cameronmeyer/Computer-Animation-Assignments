...
public:
	...
	// Create variables to keep track of rotation degrees for a single increment
	float rotateA = 0, rotateB = 0;

	// Create variables to keep track of total (absolute) rotation degrees
	float totalAngleA = 0, totalAngleB = 0;
